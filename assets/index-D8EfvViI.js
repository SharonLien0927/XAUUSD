...
*/var _m,hi,ym,jo,uu,vm,Em,Im;(function(){var n,t=Object.defineProperty;function e(a){a=[typeof globalThis=="object"&&globalThis,a,typeof window=="object"&&window,typeof self=="object"&&self,typeof Vo=="object"&&Vo];for(var h=0;h<a.length;++h){var f=a[h];if(f&&f.Math==Math)return f}throw Error("Cannot find global object")}var s=e(this);function r(a,h){if(h)t:{var f=s;a=a.split(".");for(var g=0;g<a.length-1;g++){var V=a[g];if(!(V in f))break t;f=f[V]}a=a[a.length-1],g=f[a],h=h(g),h!=g&&h!=null&&t(f,a,{configurable:!0,writable:!0,value:h})}}r("Symbol.dispose",function(a){return a||Symbol("Symbol.dispose")}),r("Array.prototype.values",function(a){return a||function(){return this[Symbol.iterator]()}}),r("Object.entries",function(a){return a||function(h){var f=[],g;for(g in h)Object.prototype.hasOwnProperty.call(h,g)&&f.push([g,h[g]]);return f}});/** @license
 ...
 Copyright The Closure Library Authors.
 SPDX-License-Identifier: Apache-2.0
*/var i=i||{},o=this||self;function l(a){var h=typeof a;return h=="object"&&a!=null||h=="function"}function u(a,h,f){return a.call.apply(a.bind,arguments)}function c(a,h,f){return c=u,c.apply(null,arguments)}function d(a,h){var f=Array.prototype.slice.call(arguments,1);return function(){var g=f.slice();return g.push.apply(g,arguments),a.apply(this,g)}}function p(a,h){function f(){}f.prototype=h.prototype,a.Z=h.prototype,a.prototype=new f,a.prototype.constructor=a,a.Ob=function(g,V,N){for(var J=Array(arguments.length-2),yt=2;yt<arguments.length;yt++)J[yt-2]=arguments[yt];return h.prototype[V].apply(g,J)}}var y=typeof AsyncContext<"u"&&typeof AsyncContext.Snapshot=="function"?a=>a&&AsyncContext.Snapshot.wrap(a):a=>a;function A(a){const h=a.length;if(h>0){const f=Array(h);for(let g=0;g<h;g++)f[g]=a[g];return f}return[]}function D(a,h){for(let g=1;g<arguments.length;g++){const V=arguments[g];var f=typeof V;if(f=f!="object"?f:V?Array.isArray(V)?"array":f:"null",f=="array"||f=="object"&&typeof V.length=="number"){f=a.length||0;const N=V.length||0;a.length=f+N;for(let J=0;J<N;J++)a[f+J]=V[J]}else a.push(V)}}class R{constructor(h,f){this.i=h,this.j=f,this.h=0,this.g=null}get(){let h;return this.h>0?(this.h--,h=this.g,this.g=h.next,h.next=null):h=this.i(),h}}function k(a){o.setTimeout(()=>{throw a},0)}function X(){var a=w;let h=null;return a.g&&(h=a.g,a.g=a.g.next,a.g||(a.h=null),h.next=null),h}class G{constructor(){this.h=this.g=null}add(h,f){const g=Q.get();g.set(h,f),this.h?this.h.next=g:this.g=g,this.h=g}}var Q=new R(()=>new W,a=>a.reset());class W{constructor(){this.next=this.g=this.h=null}set(h,f){this.h=h,this.g=f,this.next=null}reset(){this.next=this.g=this.h=null}}let nt,ut=!1,w=new G,v=()=>{const a=Promise.resolve(void 0);nt=()=>{a.then(_)}};function _(){for(var a;a=X();){try{a.h.call(a.g)}catch(f){k(f)}var h=Q;h.j(a),h.h<100&&(h.h++,a.next=h.g,h.g=a)}ut=!1}function b(){this.u=this.u,this.C=this.C}b.prototype.u=!1,b.prototype.dispose=function(){this.u||(this.u=!0,this.N())},b.prototype[Symbol.dispose]=function(){this.dispose()},b.prototype.N=function(){if(this.C)for(;this.C.length;)this.C.shift()()};function I(a,h){this.type=a,this.g=this.target=h,this.defaultPrevented=!1}I.prototype.h=function(){this.defaultPrevented=!0};var P=function(){if(!o.addEventListener||!Object.defineProperty)return!1;var a=!1,h=Object.defineProperty({},"passive",{get:function(){a=!0}});try{const f=()=>{};o.addEventListener("test",f,h),o.removeEventListener("test",f,h)}catch{}return a}();function E(a){return/^[\s\xa0]*$/.test(a)}function rt(a,h){I.call(this,a?a.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,a&&this.init(a,h)}p(rt,I),rt.prototype.init=function(a,h){const f=this.type=a.type,g=a.changedTouches&&a.changedTouches.length?a.changedTouches[0]:null;this.target=a.target||a.srcElement,this.g=h,h=a.relatedTarget,h||(f=="mouseover"?h=a.fromElement:f=="mouseout"&&(h=a.toElement)),this.relatedTarget=h,g?(this.clientX=g.clientX!==void 0?g.clientX:g.pageX,this.clientY=g.clientY!==void 0?g.clientY:g.pageY,this.screenX=g.screenX||0,this.screenY=g.screenY||0):(this.clientX=a.clientX!==void 0?a.clientX:a.pageX,this.clientY=a.clientY!==void 0?a.clientY:a.pageY,this.screenX=a.screenX||0,this.screenY=a.screenY||0),this.button=a.button,this.key=a.key||"",this.ctrlKey=a.ctrlKey,this.altKey=a.altKey,this.shiftKey=a.shiftKey,this.metaKey=a.metaKey,this.pointerId=a.pointerId||0,this.pointerType=a.pointerType,this.state=a.state,this.i=a,a.defaultPrevented&&rt.Z.h.call(this)},rt.prototype.h=function(){rt.Z.h.call(this);const a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var M="closure_listenable_"+(Math.random()*1e6|0),L=0;function x(a,h,f,g,V){this.listener=a,this.proxy=null,this.src=h,this.type=f,this.capture=!!g,this.ha=V,this.key=++L,this.da=this.fa=!1}function H(a){a.da=!0,a.listener=null,a.proxy=null,a.src=null,a.ha=null}function Ot(a,h,f){for(const g in a)h.call(f,a[g],g,a)}function Re(a,h){for(const f in a)h.call(void 0,a[f],f,a)}function Ae(a){const h={};for(const f in a)h[f]=a[f];return h}const ge="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Ks(a,h){let f,g;for(let V=1;V<arguments.length;V++){g=arguments[V];for(f in g)a[f]=g[f];for(let N=0;N<ge.length;N++)f=ge[N],Object.prototype.hasOwnProperty.call(g,f)&&(a[f]=g[f])}}function ee(a){this.src=a,this.g={},this.h=0}ee.prototype.add=function(a,h,f,g,V){const N=a.toString();a=this.g[N],a||(a=this.g[N]=[],this.h++);const J=Ke(a,h,g,V);return J>-1?(h=a[J],f||(h.fa=!1)):(h=new x(h,this.src,N,!!g,V),h.fa=f,a.push(h)),h};function Xe(a,h){const f=h.type;if(f in a.g){var g=a.g[f],V=Array.prototype.indexOf.call(g,h,void 0),N;(N=V>=0)&&Array.prototype.splice.call(g,V,1),N&&(H(h),a.g[f].length==0&&(delete a.g[f],a.h--))}}function Ke(a,h,f,g){for(let V=0;V<a.length;++V){const N=a[V];if(!N.da&&N.listener==h&&N.capture==!!f&&N.ha==g)return V}return-1}var Je="closure_lm_"+(Math.random()*1e6|0),as={};function Ur(a,h,f,g,V){if(Array.isArray(h)){for(let N=0;N<h.length;N++)Ur(a,h[N],f,g,V);return null}return f=Y(f),a&&a[M]?a.J(h,f,l(g)?!!g.capture:!1,V):ls(a,h,f,!1,g,V)}function ls(a,h,f,g,V,N){if(!h)throw Error("Invalid event type");const J=l(V)?!!V.capture:!!V;let yt=B(a);if(yt||(a[Je]=yt=new ee(a)),f=yt.add(h,f,g,J,N),f.proxy)return f;if(g=jc(),f.proxy=g,g.src=a,g.listener=f,a.addEventListener)P||(V=J),V===void 0&&(V=!1),a.addEventListener(h.toString(),g,V);else if(a.attachEvent)a.attachEvent(O(h.toString()),g);else if(a.addListener&&a.removeListener)a.addListener(g);else throw Error("addEventListener and attachEvent are unavailable.");return f}function jc(){function a(f){return h.call(a.src,a.listener,f)}const h=z;return a}function T(a,h,f,g,V){if(Array.isArray(h))for(var N=0;N<h.length;N++)T(a,h[N],f,g,V);else g=l(g)?!!g.capture:!!g,f=Y(f),a&&a[M]?(a=a.i,N=String(h).toString(),N in a.g&&(h=a.g[N],f=Ke(h,f,g,V),f>-1&&(H(h[f]),Array.prototype.splice.call(h,f,1),h.length==0&&(delete a.g[N],a.h--)))):a&&(a=B(a))&&(h=a.g[h.toString()],a=-1,h&&(a=Ke(h,f,g,V)),(f=a>-1?h[a]:null)&&S(f))}function S(a){if(typeof a!="number"&&a&&!a.da){var h=a.src;if(h&&h[M])Xe(h.i,a);else{var f=a.type,g=a.proxy;h.removeEventListener?h.removeEventListener(f,g,a.capture):h.detachEvent?h.detachEvent(O(f),g):h.addListener&&h.removeListener&&h.removeListener(g),(f=B(h))?(Xe(f,a),f.h==0&&(f.src=null,h[Je]=null)):H(a)}}}function O(a){return a in as?as[a]:as[a]="on"+a}function z(a,h){if(a.da)a=!0;else{h=new rt(h,this);const f=a.listener,g=a.ha||a.src;a.fa&&S(a),a=f.call(g,h)}return a}function B(a){return a=a[Je],a instanceof ee?a:null}var U="__closure_events_fn_"+(Math.random()*1e9>>>0);function Y(a){return typeof a=="function"?a:(a[U]||(a[U]=function(h){return a.handleEvent(h)}),a[U])}function q(){b.call(this),this.i=new ee(this),this.M=this,this.G=null}p(q,b),q.prototype[M]=!0,q.prototype.removeEventListener=function(a,h,f,g){T(this,a,h,f,g)};function j(a,h){var f,g=a.G;if(g)for(f=[];g;g=g.G)f.push(g);if(a=a.M,g=h.type||h,typeof h=="string")h=new I(h,a);else if(h instanceof I)h.target=h.target||a;else{var V=h;h=new I(g,a),Ks(h,V)}V=!0;let N,J;if(f)for(J=f.length-1;J>=0;J--)N=h.g=f[J],V=$(N,g,!0,h)&&V;if(N=h.g=a,V=$(N,g,!0,h)&&V,V=$(N,g,!1,h)&&V,f)for(J=0;J<f.length;J++)N=h.g=f[J],V=$(N,g,!1,h)&&V}q.prototype.N=function(){if(q.Z.N.call(this),this.i){var a=this.i;for(const h in a.g){const f=a.g[h];for(let g=0;g<f.length;g++)H(f[g]);delete a.g[h],a.h--}}this.G=null},q.prototype.J=function(a,h,f,g){return this.i.add(String(a),h,!1,f,g)},q.prototype.K=function(a,h,f,g){return this.i.add(String(a),h,!0,f,g)};function $(a,h,f,g){if(h=a.i.g[String(h)],!h)return!0;h=h.concat();let V=!0;for(let N=0;N<h.length;++N){const J=h[N];if(J&&!J.da&&J.capture==f){const yt=J.listener,Yt=J.ha||J.src;J.fa&&Xe(a.i,J),V=yt.call(Yt,g)!==!1&&V}}return V&&!g.defaultPrevented}function ct(a,h){if(typeof a!="function")if(a&&typeof a.handleEvent=="function")a=c(a.handleEvent,a);else throw Error("Invalid listener argument");return Number(h)>2147483647?-1:o.setTimeout(a,h||0)}function tt(a){a.g=ct(()=>{a.g=null,a.i&&(a.i=!1,tt(a))},a.l);const h=a.h;a.h=null,a.m.apply(null,h)}class ot extends b{constructor(h,f){super(),this.m=h,this.l=f,this.h=null,this.i=!1,this.g=null}j(h){this.h=arguments,this.g?this.i=!0:tt(this)}N(){super.N(),this.g&&(o.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function ht(a){b.call(this),this.h=a,this.g={}}p(ht,b);var It=[];function Dt(a){Ot(a.g,function(h,f){this.g.hasOwnProperty(f)&&S(h)},a),a.g={}}ht.prototype.N=function(){ht.Z.N.call(this),Dt(this)},ht.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")};var St=o.JSON.stringify,le=o.JSON.parse,ue=class{stringify(a){return o.JSON.stringify(a,void 0)}parse(a){return o.JSON.parse(a,void 0)}};function xe(){}function Pe(){}var He={OPEN:"a",hb:"b",ERROR:"c",tb:"d"};function Hs(){I.call(this,"d")}p(Hs,I);function ie(){I.call(this,"c")}p(ie,I);var ne={},$r=null;function us(){return $r=$r||new q}ne.Ia="serverreachability";function qc(a){I.call(this,ne.Ia,a)}p(qc,I);function jr(a){const h=us();j(h,new qc(h))}ne.STAT_EVENT="statevent";function zc(a,h){I.call(this,ne.STAT_EVENT,a),this.stat=h}p(zc,I);function _e(a){const h=us();j(h,new zc(h,a))}ne.Ja="timingevent";function Kc(a,h){I.call(this,ne.Ja,a),this.size=h}p(Kc,I);function qr(a,h){if(typeof a!="function")throw Error("Fn must not be null and must be a function");return o.setTimeout(function(){a()},h)}function zr(){this.g=!0}zr.prototype.ua=function(){this.g=!1};function k_(a,h,f,g,V,N){a.info(function(){if(a.g)if(N){var J="",yt=N.split("&");for(let Ft=0;Ft<yt.length;Ft++){var Yt=yt[Ft].split("=");if(Yt.length>1){const se=Yt[0];Yt=Yt[1];const Ze=se.split("_");J=Ze.length>=2&&Ze[1]=="type"?J+(se+"="+Yt+"&"):J+(se+"=redacted&")}}}else J=null;else J=N;return"XMLHTTP REQ ("+g+") [attempt "+V+"]: "+h+`
`+f+`
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Tm{constructor(t,e){this.user=e,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${t}`)}}class mb{getToken(){return Promise.resolve(null)}invalidateToken(){}start(t,e){t.enqueueRetryable(()=>e(oe.UNAUTHENTICATED))}shutdown(){}}class gb{constructor(t){this.token=t,this.changeListener=null}getToken(){return Promise.resolve(this.token)}invalidateToken(){}start(t,e){this.changeListener=e,t.enqueueRetryable(()=>e(this.token.user))}shutdown(){this.changeListener=null}}class _b{constructor(t){this.t=t,this.currentUser=oe.UNAUTHENTICATED,this.i=0,this.forceRefresh=!1,this.auth=null}start(t,e){it(this.o===void 0,42304);let s=this.i;const r=u=>this.i!==s?(s=this.i,e(u)):Promise.resolve();let i=new bn;this.o=()=>{this.i++,this.currentUser=this.u(),i.resolve(),i=new bn,t.enqueueRetryable(()=>r(this.currentUser))};const o=()=>{const u=i;t.enqueueRetryable(async()=>{await u.promise,await r(this.currentUser)})},l=u=>{K("FirebaseAuthCredentialsProvider","Auth detected"),this.auth=u,this.o&&(this.auth.addAuthTokenListener(this.o),o())};this.t.onInit(u=>l(u)),setTimeout(()=>{if(!this.auth){const u=this.t.getImmediate({optional:!0});u?l(u):(K("FirebaseAuthCredentialsProvider","Auth not yet detected"),i.resolve(),i=new bn)}},0),o()}getToken(){const t=this.i,e=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(e).then(s=>this.i!==t?(K("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):s?(it(typeof s.accessToken=="string",31837,{l:s}),new Tm(s.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.o&&this.auth.removeAuthTokenListener(this.o),this.o=void 0}u(){const t=this.auth&&this.auth.getUid();return it(t===null||typeof t=="string",2055,{h:t}),new oe(t)}}class yb{constructor(t,e,s){this.P=t,this.T=e,this.I=s,this.type="FirstParty",this.user=oe.FIRST_PARTY,this.A=new Map}R(){return this.I?this.I():null}get headers(){this.A.set("X-Goog-AuthUser",this.P);const t=this.R();return t&&this.A.set("Authorization",t),this.T&&this.A.set("X-Goog-Iam-Authorization-Token",this.T),this.A}}class vb{constructor(t,e,s){this.P=t,this.T=e,this.I=s}getToken(){return Promise.resolve(new yb(this.P,this.T,this.I))}start(t,e){t.enqueueRetryable(()=>e(oe.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class Ad{constructor(t){this.value=t,this.type="AppCheck",this.headers=new Map,t&&t.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class Eb{constructor(t,e){this.V=e,this.forceRefresh=!1,this.appCheck=null,this.m=null,this.p=null,YI(t)&&t.settings.appCheckToken&&(this.p=t.settings.appCheckToken)}start(t,e){it(this.o===void 0,3512);const s=i=>{i.error!=null&&K("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${i.error.message}`);const o=i.token!==this.m;return this.m=i.token,K("FirebaseAppCheckTokenProvider",`Received ${o?"new":"existing"} token.`),o?e(i.token):Promise.resolve()};this.o=i=>{t.enqueueRetryable(()=>s(i))};const r=i=>{K("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=i,this.o&&this.appCheck.addTokenListener(this.o)};this.V.onInit(i=>r(i)),setTimeout(()=>{if(!this.appCheck){const i=this.V.getImmediate({optional:!0});i?r(i):K("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){if(this.p)return Promise.resolve(new Ad(this.p));const t=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(t).then(e=>e?(it(typeof e.token=="string",44558,{tokenResult:e}),this.m=e.token,new Ad(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.o&&this.appCheck.removeTokenListener(this.o),this.o=void 0}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function kg(n){var e,s;if(it(n instanceof bt||n instanceof Mt,20012),n instanceof bt){if(n instanceof ng){const r=((s=(e=n.value.arrayValue)==null?void 0:e.values)==null?void 0:s.map(i=>bt.create(n.field,"==",i)))||[];return Mt.create(r,"or")}return n}const t=n.filters.map(r=>kg(r));return Mt.create(t,n.op)}function ow(n){if(n.getFilters().length===0)return[];const t=xu(kg(n));return it(Ng(t),7391),Su(t)||Ru(t)?[t]:t.getFilters()}function Su(n){return n instanceof bt}function Ru(n){return n instanceof Mt&&fc(n)}function Ng(n){return Su(n)||Ru(n)||function(e){if(e instanceof Mt&&yu(e)){for(const s of e.getFilters())if(!Su(s)&&!Ru(s))return!1;return!0}return!1}(n)}function xu(n){if(it(n instanceof bt||n instanceof Mt,34018),n instanceof bt)return n;if(n.filters.length===1)return xu(n.filters[0]);const t=n.filters.map(s=>xu(s));let e=Mt.create(t,n.op);return e=wa(e),Ng(e)?e:(it(e instanceof Mt,64498),it(Cr(e),40251),it(e.filters.length>1,57927),e.filters.reduce((s,r)=>Ic(s,r)))}function Ic(n,t){let e;return it(n instanceof bt||n instanceof Mt,38388),it(t instanceof bt||t instanceof Mt,25473),e=n instanceof bt?t instanceof bt?function(r,i){return Mt.create([r,i],"and")}(n,t):df(n,t):t instanceof bt?df(t,n):function(r,i){if(it(r.filters.length>0&&i.filters.length>0,48005),Cr(r)&&Cr(i))return Zm(r,i.getFilters());const o=yu(r)?r:i,l=yu(r)?i:r,u=o.filters.map(c=>Ic(c,l));return Mt.create(u,"or")}(n,t),wa(e)}function df(n,t){if(Cr(t))return Zm(t,n.getFilters());{const e=t.filters.map(s=>Ic(n,s));return Mt.create(e,"or")}}function wa(n){if(it(n instanceof bt||n instanceof Mt,11850),n instanceof bt)return n;const t=n.getFilters();if(t.length===1)return wa(t[0]);if(Jm(n))return n;const e=t.map(r=>wa(r)),s=[];return e.forEach(r=>{r instanceof bt?s.push(r):r instanceof Mt&&(r.op===n.op?s.push(...r.filters):s.push(r))}),s.length===1?s[0]:Mt.create(s,n.op)}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */de.DEFAULT_COLLECTION_PERCENTILE=10,de.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT=1e3,de.DEFAULT=new de(Mg,de.DEFAULT_COLLECTION_PERCENTILE,de.DEFAULT_MAX_SEQUENCE_NUMBERS_TO_COLLECT),de.DISABLED=new de(-1,0,0);class sl{constructor(t,e,s,r){this.userId=t,this.serializer=e,this.indexManager=s,this.referenceDelegate=r,this.Xn={}}static wt(t,e,s,r){it(t.uid!=="",64387);const i=t.isAuthenticated()?t.uid:"";return new sl(i,e,s,r)}checkEmpty(t){let e=!0;const s=IDBKeyRange.bound([this.userId,Number.NEGATIVE_INFINITY],[this.userId,Number.POSITIVE_INFINITY]);return Bn(t).ee({index:Ss,range:s},(r,i,o)=>{e=!1,o.done()}).next(()=>e)}addMutationBatch(t,e,s,r){const i=ur(t),o=Bn(t);return o.add({}).next(l=>{it(typeof l=="number",49019);const u=new gc(l,e,s,r),c=function(A,D,R){const k=R.baseMutations.map(G=>ba(A.yt,G)),X=R.mutations.map(G=>ba(A.yt,G));return{userId:D,batchId:R.batchId,localWriteTimeMs:R.localWriteTime.toMillis(),baseMutations:k,mutations:X}}(this.serializer,this.userId,u),d=[];let p=new kt((y,A)=>pt(y.canonicalString(),A.canonicalString()));for(const y of r){const A=Cm(this.userId,y.key.path,l);p=p.add(y.key.path.popLast()),d.push(o.put(c)),d.push(i.put(A,Mb))}return p.forEach(y=>{d.push(this.indexManager.addToCollectionParentIndex(t,y))}),t.addOnCommittedListener(()=>{this.Xn[l]=u.keys()}),C.waitFor(d).next(()=>u)})}lookupMutationBatch(t,e){return Bn(t).get(e).next(s=>s?(it(s.userId===this.userId,48,"Unexpected user for mutation batch",{userId:s.userId,batchId:e}),bs(this.serializer,s)):null)}er(t,e){return this.Xn[e]?C.resolve(this.Xn[e]):this.lookupMutationBatch(t,e).next(s=>{if(s){const r=s.keys();return this.Xn[e]=r,r}return null})}getNextMutationBatchAfterBatchId(t,e){const s=e+1,r=IDBKeyRange.lowerBound([this.userId,s]);let i=null;return Bn(t).ee({index:Ss,range:r},(o,l,u)=>{l.userId===this.userId&&(it(l.batchId>=s,47524,{tr:s}),i=bs(this.serializer,l)),u.done()}).next(()=>i)}getHighestUnacknowledgedBatchId(t){const e=IDBKeyRange.upperBound([this.userId,Number.POSITIVE_INFINITY]);let s=Ps;return Bn(t).ee({index:Ss,range:e,reverse:!0},(r,i,o)=>{s=i.batchId,o.done()}).next(()=>s)}getAllMutationBatches(t){const e=IDBKeyRange.bound([this.userId,Ps],[this.userId,Number.POSITIVE_INFINITY]);return Bn(t).J(Ss,e).next(s=>s.map(r=>bs(this.serializer,r)))}getAllMutationBatchesAffectingDocumentKey(t,e){const s=zo(this.userId,e.path),r=IDBKeyRange.lowerBound(s),i=[];return ur(t).ee({range:r},(o,l,u)=>{const[c,d,p]=o,y=rn(d);if(c===this.userId&&e.path.isEqual(y))return Bn(t).get(p).next(A=>{if(!A)throw st(61480,{nr:o,batchId:p});it(A.userId===this.userId,10503,"Unexpected user for mutation batch",{userId:A.userId,batchId:p}),i.push(bs(this.serializer,A))});u.done()}).next(()=>i)}getAllMutationBatchesAffectingDocumentKeys(t,e){let s=new kt(pt);const r=[];return e.forEach(i=>{const o=zo(this.userId,i.path),l=IDBKeyRange.lowerBound(o),u=ur(t).ee({range:l},(c,d,p)=>{const[y,A,D]=c,R=rn(A);y===this.userId&&i.path.isEqual(R)?s=s.add(D):p.done()});r.push(u)}),C.waitFor(r).next(()=>this.rr(t,s))}getAllMutationBatchesAffectingQuery(t,e){const s=e.path,r=s.length+1,i=zo(this.userId,s),o=IDBKeyRange.lowerBound(i);let l=new kt(pt);return ur(t).ee({range:o},(u,c,d)=>{const[p,y,A]=u,D=rn(y);p===this.userId&&s.isPrefixOf(D)?D.length===r&&(l=l.add(A)):d.done()}).next(()=>this.rr(t,l))}rr(t,e){const s=[],r=[];return e.forEach(i=>{r.push(Bn(t).get(i).next(o=>{if(o===null)throw st(35274,{batchId:i});it(o.userId===this.userId,9748,"Unexpected user for mutation batch",{userId:o.userId,batchId:i}),s.push(bs(this.serializer,o))}))}),C.waitFor(r).next(()=>s)}removeMutationBatch(t,e){return Og(t.le,this.userId,e).next(s=>(t.addOnCommittedListener(()=>{this.ir(e.batchId)}),C.forEach(s,r=>this.referenceDelegate.markPotentiallyOrphaned(t,r))))}ir(t){delete this.Xn[t]}performConsistencyCheck(t){return this.checkEmpty(t).next(e=>{if(!e)return C.resolve();const s=IDBKeyRange.lowerBound(function(o){return[o]}(this.userId)),r=[];return ur(t).ee({range:s},(i,o,l)=>{if(i[0]===this.userId){const u=rn(i[1]);r.push(u)}else l.done()}).next(()=>{it(r.length===0,56720,{sr:r.map(i=>i.canonicalString())})})})}containsKey(t,e){return Fg(t,this.userId,e)}_r(t){return Lg(t).get(this.userId).next(e=>e||{userId:this.userId,lastAcknowledgedBatchId:Ps,lastStreamToken:""})}}function Fg(n,t,e){const s=zo(t,e.path),r=s[1],i=IDBKeyRange.lowerBound(s);let o=!1;return ur(n).ee({range:i,X:!0},(l,u,c)=>{const[d,p,y]=l;d===t&&p===r&&(o=!0),c.done()}).next(()=>o)}function Bn(n){return te(n,Ge)}function ur(n){return te(n,Tr)}function Lg(n){return te(n,Gi)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ce="WebChannelConnection";class $w extends Bw{constructor(t){super(t),this.c_=[],this.forceLongPolling=t.forceLongPolling,this.autoDetectLongPolling=t.autoDetectLongPolling,this.useFetchStreams=t.useFetchStreams,this.longPollingOptions=t.longPollingOptions}Jo(t,e,s,r,i){const o=Cu();return new Promise((l,u)=>{const c=new _m;c.setWithCredentials(!0),c.listenOnce(ym.COMPLETE,()=>{try{switch(c.getLastErrorCode()){case jo.NO_ERROR:const p=c.getResponseJson();K(ce,`XHR for RPC '${t}' ${o} received:`,JSON.stringify(p)),l(p);break;case jo.TIMEOUT:K(ce,`RPC '${t}' ${o} timed out`),u(new et(F.DEADLINE_EXCEEDED,"Request time out"));break;case jo.HTTP_ERROR:const y=c.getStatus();if(K(ce,`RPC '${t}' ${o} failed with status:`,y,"response text:",c.getResponseText()),y>0){let A=c.getResponseJson();Array.isArray(A)&&(A=A[0]);const D=A==null?void 0:A.error;if(D&&D.status&&D.message){const R=function(X){const G=X.toLowerCase().replace(/_/g,"-");return Object.values(F).indexOf(G)>=0?G:F.UNKNOWN}(D.status);u(new et(R,D.message))}else u(new et(F.UNKNOWN,"Server responded with status "+c.getStatus()))}else u(new et(F.UNAVAILABLE,"Connection failed."));break;default:st(9055,{l_:t,streamId:o,h_:c.getLastErrorCode(),P_:c.getLastError()})}}finally{K(ce,`RPC '${t}' ${o} completed.`)}});const d=JSON.stringify(r);K(ce,`RPC '${t}' ${o} sending request:`,r),c.send(e,"POST",d,s,15)})}T_(t,e,s){const r=Cu(),i=[this.Uo,"/","google.firestore.v1.Firestore","/",t,"/channel"],o=Im(),l=Em(),u={httpSessionIdParam:"gsessionid",initMessageHeaders:{},messageUrlParams:{database:`projects/${this.databaseId.projectId}/databases/${this.databaseId.database}`},sendRawJson:!0,supportsCrossDomainXhr:!0,internalChannelParams:{forwardChannelRequestTimeoutMs:6e5},forceLongPolling:this.forceLongPolling,detectBufferingProxy:this.autoDetectLongPolling},c=this.longPollingOptions.timeoutSeconds;c!==void 0&&(u.longPollingTimeout=Math.round(1e3*c)),this.useFetchStreams&&(u.useFetchStreams=!0),this.jo(u.initMessageHeaders,e,s),u.encodeInitMessageHeaders=!0;const d=i.join("");K(ce,`Creating RPC '${t}' stream ${r}: ${d}`,u);const p=o.createWebChannel(d,u);this.I_(p);let y=!1,A=!1;const D=new Uw({Yo:k=>{A?K(ce,`Not sending because RPC '${t}' stream ${r} is closed:`,k):(y||(K(ce,`Opening RPC '${t}' stream ${r} transport.`),p.open(),y=!0),K(ce,`RPC '${t}' stream ${r} sending:`,k),p.send(k))},Zo:()=>p.close()}),R=(k,X,G)=>{k.listen(X,Q=>{try{G(Q)}catch(W){setTimeout(()=>{throw W},0)}})};return R(p,hi.EventType.OPEN,()=>{A||(K(ce,`RPC '${t}' stream ${r} transport opened.`),D.o_())}),R(p,hi.EventType.CLOSE,()=>{A||(A=!0,K(ce,`RPC '${t}' stream ${r} transport closed`),D.a_(),this.E_(p))}),R(p,hi.EventType.ERROR,k=>{A||(A=!0,Ns(ce,`RPC '${t}' stream ${r} transport errored. Name:`,k.name,"Message:",k.message),D.a_(new et(F.UNAVAILABLE,"The operation could not be completed")))}),R(p,hi.EventType.MESSAGE,k=>{var X;if(!A){const G=k.data[0];it(!!G,16349);const Q=G,W=(Q==null?void 0:Q.error)||((X=Q[0])==null?void 0:X.error);if(W){K(ce,`RPC '${t}' stream ${r} received error:`,W);const nt=W.status;let ut=function(_){const b=Wt[_];if(b!==void 0)return gg(b)}(nt),w=W.message;ut===void 0&&(ut=F.INTERNAL,w="Unknown error status: "+nt+" with message "+W.message),A=!0,D.a_(new et(ut,w)),p.close()}else K(ce,`RPC '${t}' stream ${r} received:`,G),D.u_(G)}}),R(l,vm.STAT_EVENT,k=>{k.stat===uu.PROXY?K(ce,`RPC '${t}' stream ${r} detected buffering proxy`):k.stat===uu.NOPROXY&&K(ce,`RPC '${t}' stream ${r} detected no buffering proxy`)}),setTimeout(()=>{D.__()},0),D}terminate(){this.c_.forEach(t=>t.close()),this.c_=[]}I_(t){this.c_.push(t)}E_(t){this.c_=this.c_.filter(e=>e===t)}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
`));return}const M={...c.value,createdAt:new Date().toISOString()};t.value.push(M),_(),A(),e.value=t.value.length-1}function R(){i.value=!i.value,o.value=[]}function k(){i.value=!1,o.value=[]}function X(rt){o.value.includes(rt)?o.value=o.value.filter(M=>M!==rt):o.value.push(rt)}function G(){o.value.length!==0&&confirm(`確定要刪除選中的 ${o.value.length} 個策略嗎？`)&&(o.value.sort((M,L)=>L-M).forEach(M=>{t.value.splice(M,1)}),_(),i.value=!1,o.value=[],e.value=null)}function Q(){l.value=!l.value,u.value=[]}function W(rt){u.value.includes(rt)?u.value=u.value.filter(M=>M!==rt):u.value.push(rt)}function nt(){l.value=!1,u.value=[]}function ut(rt){i.value?X(rt):l.value||(e.value=rt)}function w(){if(u.value.length===0)return;const rt=u.value.map(Ot=>t.value[Ot]),M=v(rt),L=new Blob([M],{type:"text/html;charset=utf-8"}),x=document.createElement("a"),H=URL.createObjectURL(L);x.setAttribute("href",H),x.setAttribute("download",`XAUUSD_策略_${new Date().toISOString().split("T")[0]}.html`),x.style.visibility="hidden",document.body.appendChild(x),x.click(),document.body.removeChild(x),l.value=!1,u.value=[]}function v(rt){const M=`
  ...
  `}function _(){localStorage.setItem("xauusd_strategies",JSON.stringify(t.value))}function b(){const rt=localStorage.getItem("xauusd_strategies");return rt?JSON.parse(rt):[]}function I(){if(e.value===null)return;const rt=t.value[e.value];d.value={date:rt.date,breakoutHigh:rt.breakoutHigh,breakoutLow:rt.breakoutLow,usRetrace:rt.usRetrace,points:rt.points,module:rt.module,description:rt.description},r.value=!0}function P(){r.value=!1}function E(){if(e.value!==null){if(!d.value.date){alert("請選擇日期");return}t.value[e.value]={...d.value,createdAt:t.value[e.value].createdAt},_(),P()}}return(rt,M)=>(lt(),dt("div",null,[m("div",K0,[m("div",H0,[M[21]||(M[21]=m("div",{class:"card-title"},"黃金策略分析",-1)),m("div",G0,[i.value?xt("",!0):(lt(),dt("button",{key:0,class:"btn-floating btn-delete-floating",onClick:R,title:"刪除策略"},[(lt(),dt("svg",W0,[...M[19]||(M[19]=[m("polyline",{points:"3 6 5 6 21 6"},null,-1),m("path",{d:"M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6m3 0V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"},null,-1),m("line",{x1:"10",y1:"11",x2:"10",y2:"17"},null,-1),m("line",{x1:"14",y1:"11",x2:"14",y2:"17"},null,-1)])]))])),i.value&&o.value.length>0?(lt(),dt("button",{key:1,class:"btn-floating btn-confirm-delete",onClick:G,title:"確認刪除"}," ✓ ")):xt("",!0),i.value?(lt(),dt("button",{key:2,class:"btn-floating btn-cancel-delete",onClick:k,title:"取消刪除"}," ✕ ")):xt("",!0),e.value!==null&&!i.value?(lt(),dt("button",{key:3,class:"btn-floating btn-edit-floating",onClick:I,title:"編輯策略"}," ✎ ")):xt("",!0),i.value?xt("",!0):(lt(),dt("button",{key:4,class:"btn-floating btn-export-floating",onClick:Q,title:"輸出策略"},[(lt(),dt("svg",Q0,[...M[20]||(M[20]=[m("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"},null,-1),m("polyline",{points:"7 10 12 15 17 10"},null,-1),m("line",{x1:"12",y1:"15",x2:"12",y2:"3"},null,-1)])]))])),i.value?xt("",!0):(lt(),dt("button",{key:5,class:"btn-floating",onClick:y},"+"))])]),t.value.length===0?(lt(),dt("div",X0,[...M[22]||(M[22]=[m("p",{style:{"font-size":"14px"}},'還沒有策略，點擊右上角"+"新增',-1)])])):xt("",!0),t.value.length>0?(lt(),dt("div",J0,[(lt(!0),dt(Ie,null,vr(t.value,(L,x)=>(lt(),dt("button",{key:x,class:Be(["strategy-button",{active:e.value===x&&!i.value&&!l.value,"delete-selected":i.value&&o.value.includes(x),"export-selected":l.value&&u.value.includes(x)}]),onClick:H=>ut(x)},[l.value?(lt(),dt("input",{key:0,type:"checkbox",checked:u.value.includes(x),onChange:H=>W(x),onClick:M[0]||(M[0]=wi(()=>{},["stop"])),style:{"margin-right":"6px",width:"16px",height:"16px",cursor:"pointer"}},null,40,Z0)):xt("",!0),As(" "+vt(L.date),1),M[23]||(M[23]=m("br",null,null,-1)),m("span",tA,vt(p(L.date)),1)],10,Y0))),128))])):xt("",!0),l.value&&u.value.length>0?(lt(),dt("div",eA,[m("button",{class:"btn btn-primary",onClick:w},"確認輸出 ("+vt(u.value.length)+")",1),m("button",{class:"btn btn-secondary",onClick:nt},"取消")])):xt("",!0),t.value.length>0&&e.value!==null?(lt(),dt("div",nA,[m("div",sA,[m("div",rA,[M[24]||(M[24]=m("span",{class:"data-label"},"日期",-1)),m("span",iA,vt(t.value[e.value].date)+" ("+vt(p(t.value[e.value].date))+")",1)])]),m("div",oA,[m("div",aA,[M[25]||(M[25]=m("span",{class:"data-label"},"突破口高點",-1)),m("span",lA,vt(t.value[e.value].breakoutHigh),1)]),m("div",uA,[M[26]||(M[26]=m("span",{class:"data-label"},"突破口低點",-1)),m("span",cA,vt(t.value[e.value].breakoutLow),1)])]),m("div",hA,[m("div",dA,[M[27]||(M[27]=m("span",{class:"data-label"},"美盤回調",-1)),m("span",fA,vt(t.value[e.value].usRetrace),1)]),m("div",pA,[M[28]||(M[28]=m("span",{class:"data-label"},"點",-1)),m("span",mA,vt(t.value[e.value].points),1)])]),m("div",gA,[m("div",_A,[M[29]||(M[29]=m("span",{class:"data-label"},"模組",-1)),m("span",yA,vt(t.value[e.value].module),1)])]),m("div",vA,[m("div",EA,[M[30]||(M[30]=m("span",{class:"data-label"},"策略",-1)),m("span",IA,vt(t.value[e.value].description),1)])])])):xt("",!0)]),s.value?(lt(),dt("div",{key:0,class:"modal-overlay",onClick:A},[m("div",{class:"modal",onClick:M[9]||(M[9]=wi(()=>{},["stop"]))},[m("div",{class:"modal-header"},[M[31]||(M[31]=m("h2",null,"新增策略",-1)),m("button",{class:"modal-close",onClick:A},"×")]),m("div",bA,[m("div",TA,[M[32]||(M[32]=m("label",null,"日期",-1)),_t(m("input",{"onUpdate:modelValue":M[1]||(M[1]=L=>c.value.date=L),type:"date",class:"form-input"},null,512),[[wt,c.value.date]]),m("div",wA,vt(c.value.date?`星期${p(c.value.date)}`:"請選擇日期"),1)]),m("div",AA,[m("div",SA,[M[33]||(M[33]=m("label",null,"突破口高點",-1)),_t(m("input",{"onUpdate:modelValue":M[2]||(M[2]=L=>c.value.breakoutHigh=L),type:"number",step:"0.01",class:"form-input",placeholder:"例如：2700"},null,512),[[wt,c.value.breakoutHigh,void 0,{number:!0}]])]),m("div",RA,[M[34]||(M[34]=m("label",null,"突破口低點",-1)),_t(m("input",{"onUpdate:modelValue":M[3]||(M[3]=L=>c.value.breakoutLow=L),type:"number",step:"0.01",class:"form-input",placeholder:"例如：2650"},null,512),[[wt,c.value.breakoutLow,void 0,{number:!0}]])])]),m("div",xA,[m("div",PA,[m("div",CA,[M[37]||(M[37]=m("label",null,"美盤回調點",-1)),m("div",VA,[m("label",DA,[_t(m("input",{"onUpdate:modelValue":M[4]||(M[4]=L=>c.value.usRetrace=L),type:"radio",value:"高"},null,512),[[Co,c.value.usRetrace]]),M[35]||(M[35]=m("span",null,"高",-1))]),m("label",kA,[_t(m("input",{"onUpdate:modelValue":M[5]||(M[5]=L=>c.value.usRetrace=L),type:"radio",value:"低"},null,512),[[Co,c.value.usRetrace]]),M[36]||(M[36]=m("span",null,"低",-1))])])]),_t(m("input",{"onUpdate:modelValue":M[6]||(M[6]=L=>c.value.points=L),type:"number",step:"0.01",class:"form-input",placeholder:"例如：50"},null,512),[[wt,c.value.points,void 0,{number:!0}]])]),m("div",NA,[M[38]||(M[38]=m("label",null,"模組",-1)),_t(m("input",{"onUpdate:modelValue":M[7]||(M[7]=L=>c.value.module=L),type:"text",class:"form-input",placeholder:"例如：模組A"},null,512),[[wt,c.value.module]])])]),m("div",MA,[M[39]||(M[39]=m("label",null,"策略",-1)),_t(m("textarea",{"onUpdate:modelValue":M[8]||(M[8]=L=>c.value.description=L),class:"form-input",rows:"5",placeholder:"詳細說明策略內容...",style:{resize:"vertical"}},null,512),[[wt,c.value.description]])])]),m("div",{class:"modal-footer"},[m("button",{class:"btn btn-secondary",onClick:A},"取消"),m("button",{class:"btn btn-primary",onClick:D},"新增策略")])])])):xt("",!0),r.value?(lt(),dt("div",{key:1,class:"modal-overlay",onClick:P},[m("div",{class:"modal",onClick:M[18]||(M[18]=wi(()=>{},["stop"]))},[m("div",{class:"modal-header"},[M[40]||(M[40]=m("h2",null,"編輯策略",-1)),m("button",{class:"modal-close",onClick:P},"×")]),m("div",OA,[m("div",FA,[M[41]||(M[41]=m("label",null,"日期",-1)),_t(m("input",{"onUpdate:modelValue":M[10]||(M[10]=L=>d.value.date=L),type:"date",class:"form-input"},null,512),[[wt,d.value.date]]),m("div",LA,vt(d.value.date?`星期${p(d.value.date)}`:"請選擇日期"),1)]),m("div",BA,[m("div",UA,[M[42]||(M[42]=m("label",null,"突破口高點",-1)),_t(m("input",{"onUpdate:modelValue":M[11]||(M[11]=L=>d.value.breakoutHigh=L),type:"number",step:"0.01",class:"form-input",placeholder:"例如：2700"},null,512),[[wt,d.value.breakoutHigh,void 0,{number:!0}]])]),m("div",$A,[M[43]||(M[43]=m("label",null,"突破口低點",-1)),_t(m("input",{"onUpdate:modelValue":M[12]||(M[12]=L=>d.value.breakoutLow=L),type:"number",step:"0.01",class:"form-input",placeholder:"例如：2650"},null,512),[[wt,d.value.breakoutLow,void 0,{number:!0}]])])]),m("div",jA,[m("div",qA,[m("div",zA,[M[46]||(M[46]=m("label",null,"美盤回調點",-1)),m("div",KA,[m("label",HA,[_t(m("input",{"onUpdate:modelValue":M[13]||(M[13]=L=>d.value.usRetrace=L),type:"radio",value:"高"},null,512),[[Co,d.value.usRetrace]]),M[44]||(M[44]=m("span",null,"高",-1))]),m("label",GA,[_t(m("input",{"onUpdate:modelValue":M[14]||(M[14]=L=>d.value.usRetrace=L),type:"radio",value:"低"},null,512),[[Co,d.value.usRetrace]]),M[45]||(M[45]=m("span",null,"低",-1))])])]),_t(m("input",{"onUpdate:modelValue":M[15]||(M[15]=L=>d.value.points=L),type:"number",step:"0.01",class:"form-input",placeholder:"例如：50"},null,512),[[wt,d.value.points,void 0,{number:!0}]])]),m("div",WA,[M[47]||(M[47]=m("label",null,"模組",-1)),_t(m("input",{"onUpdate:modelValue":M[16]||(M[16]=L=>d.value.module=L),type:"text",class:"form-input",placeholder:"例如：模組A"},null,512),[[wt,d.value.module]])])]),m("div",QA,[M[48]||(M[48]=m("label",null,"策略",-1)),_t(m("textarea",{"onUpdate:modelValue":M[17]||(M[17]=L=>d.value.description=L),class:"form-input",rows:"5",placeholder:"詳細說明策略內容...",style:{resize:"vertical"}},null,512),[[wt,d.value.description]])])]),m("div",{class:"modal-footer"},[m("button",{class:"btn btn-secondary",onClick:P},"取消"),m("button",{class:"btn btn-primary",onClick:E},"保存修改")])])])):xt("",!0)]))}}),$c=(n,t)=>{const e=n.__vccOpts||n;for(const[s,r]of t)e[s]=r;return e},JA=$c(XA,[["__scopeId","data-v-4aab2519"]]),YA={class:"card"},ZA={key:0,style:{"text-align":"center",padding:"32px",color:"var(--color-text-secondary)"}},tS={style:{display:"flex","justify-content":"space-between","align-items":"start"}},eS={style:{flex:"1"}},nS={class:"data-label"},sS={style:{"font-size":"14px","margin-top":"6px",color:"var(--color-text-primary)"}},rS=["onClick"],iS={style:{"margin-top":"8px"}},oS={class:"card"},aS={class:"form-group",style:{"margin-bottom":"12px"}},lS={class:"form-group",style:{"margin-bottom":"12px"}},uS=io({__name:"Rules",setup(n){const t=Pt(o()),e=Pt({content:"",priority:"高"});function s(){if(!e.value.content){alert("請填寫守則內容");return}const l={content:e.value.content,priority:e.value.priority,createdAt:new Date().toISOString()};t.value.push(l),i(),e.value={content:"",priority:"高"}}function r(l){t.value.splice(l,1),i()}function i(){localStorage.setItem("xauusd_rules",JSON.stringify(t.value))}function o(){const l=localStorage.getItem("xauusd_rules");return l?JSON.parse(l):[]}return(l,u)=>(lt(),dt("div",null,[m("div",YA,[u[4]||(u[4]=m("div",{class:"card-title"},"交易守則",-1)),t.value.length===0?(lt(),dt("div",ZA,[...u[2]||(u[2]=[m("p",{style:{"font-size":"14px"}},"還沒有守則，點擊下方按鈕新增",-1)])])):xt("",!0),(lt(!0),dt(Ie,null,vr(t.value,(c,d)=>(lt(),dt("div",{key:d,class:"data-row",style:{"flex-direction":"column"}},[m("div",tS,[m("div",eS,[m("span",nS,"規則 #"+vt(d+1),1),m("p",sS,vt(c.content),1)]),m("button",{class:"btn btn-danger",onClick:p=>r(d),style:{"margin-left":"12px"}},"刪除",8,rS)]),m("div",iS,[u[3]||(u[3]=m("span",{class:"data-label"},"優先級",-1)),m("span",{class:Be(["data-value",c.priority==="高"?"negative":c.priority==="中"?"highlight":"positive"])},vt(c.priority),3)])]))),128))]),m("div",oS,[u[8]||(u[8]=m("div",{class:"card-title"},"新增守則",-1)),m("div",aS,[u[5]||(u[5]=m("label",null,"守則內容",-1)),_t(m("textarea",{"onUpdate:modelValue":u[0]||(u[0]=c=>e.value.content=c),class:"form-input",rows:"3",placeholder:"例如：不能超過資本金的2%風險，必須等待確認信號...",style:{resize:"vertical"}},null,512),[[wt,e.value.content]])]),m("div",lS,[u[7]||(u[7]=m("label",null,"優先級",-1)),_t(m("select",{"onUpdate:modelValue":u[1]||(u[1]=c=>e.value.priority=c),class:"form-select"},[...u[6]||(u[6]=[m("option",{value:"高"},"高 (必須遵守)",-1),m("option",{value:"中"},"中 (重要)",-1),m("option",{value:"低"},"低 (參考)",-1)])],512),[[eu,e.value.priority]])]),m("button",{class:"btn btn-primary",onClick:s},"新增守則")])]))}}),cS=$c(uS,[["__scopeId","data-v-62aaea1e"]]),hS={class:"card"},dS={class:"card-header"},fS={class:"button-group"},pS={width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",style:{color:"#0f1419"}},mS={viewBox:"0 0 24 24",width:"18",height:"18",fill:"none",stroke:"currentColor","stroke-width":"2","stroke-linecap":"round","stroke-linejoin":"round",style:{display:"inline-block"}},gS={key:0,style:{"text-align":"center",padding:"32px",color:"var(--color-text-secondary)"}},_S={key:1,class:"record-buttons"},yS=["onClick"],vS={style:{"font-size":"11px"}},ES={key:2,class:"record-details"},IS={class:"data-row",style:{"margin-bottom":"8px"}},bS={class:"data-item"},TS={class:"data-value"},wS={class:"data-row",style:{"margin-bottom":"8px"}},AS={class:"data-item"},SS={class:"data-item"},RS={class:"data-value highlight"},xS={class:"data-row",style:{"margin-bottom":"8px"}},PS={class:"data-item"},CS={class:"data-value"},VS={class:"data-item"},DS={key:0,class:"data-row"},kS={class:"data-item",style:{"flex-direction":"column","align-items":"flex-start"}},NS={class:"data-value",style:{"white-space":"pre-wrap","margin-top":"8px"}},MS={class:"modal-body"},OS={class:"grid-2",style:{"margin-bottom":"12px"}},FS={class:"form-group"},LS={class:"form-group"},BS={class:"grid-2",style:{"margin-bottom":"12px"}},US={class:"form-group"},$S={class:"form-group"},jS={class:"form-group",style:{"margin-bottom":"12px"}},qS={class:"form-group",style:{"margin-bottom":"12px"}},zS={class:"modal-body"},KS={class:"grid-2",style:{"margin-bottom":"12px"}},HS={class:"form-group"},GS={class:"form-group"},WS={class:"grid-2",style:{"margin-bottom":"12px"}},QS={class:"form-group"},XS={class:"form-group"},JS={class:"form-group",style:{"margin-bottom":"12px"}},YS={class:"form-group",style:{"margin-bottom":"12px"}},ZS={key:2,class:"card"},tR={class:"month-buttons",style:{"margin-bottom":"16px"}},eR=["onClick"],nR={key:0,style:{display:"flex",gap:"8px","margin-bottom":"16px","align-items":"center"}},sR={style:{color:"var(--color-text-secondary)","font-size":"14px"}},rR={class:"grid-3"},iR={class:"data-row"},oR={class:"data-item"},aR={class:"data-value highlight"},lR={class:"data-row"},uR={class:"data-item"},cR={class:"data-row"},hR={class:"data-item"},dR={class:"data-value highlight"},fR=io({__name:"Records",setup(n){const t=Pt(M()),e=Pt(null),s=Pt(null),r=Pt(!1),i=Pt(!1),o=Pt(!1),l=Pt(!1),u=Pt([]),c=Pt({timestamp:new Date().toISOString().slice(0,16),type:"空單 Sell Limit",price:0,quantity:0,profitLoss:0,notes:""}),d=Pt({timestamp:"",type:"",price:0,quantity:0,profitLoss:0,notes:""});De(()=>t.value.reduce((L,x)=>L+parseFloat(x.profitLoss),0)),De(()=>t.value.length===0?0:t.value.filter(x=>parseFloat(x.profitLoss)>0).length/t.value.length*100),De(()=>{if(t.value.length===0)return"";const L=new Set;return t.value.forEach(x=>{const H=new Date(x.timestamp),Ot=H.getFullYear(),Re=H.getMonth()+1;L.add(`${Ot}年${Re}月`)}),Array.from(L).reverse().join(", ")});const p=De(()=>{const L=new Set;return t.value.forEach(x=>{const H=new Date(x.timestamp),Ot=H.getFullYear(),Re=H.getMonth()+1;L.add(`${Ot}年${Re}月`)}),Array.from(L).reverse()}),y=De(()=>s.value?t.value.filter(L=>{const x=new Date(L.timestamp),H=x.getFullYear(),Ot=x.getMonth()+1;return`${H}年${Ot}月`===s.value}):t.value),A=De(()=>y.value.reduce((L,x)=>L+parseFloat(x.profitLoss),0)),D=De(()=>y.value.length===0?0:y.value.filter(x=>parseFloat(x.profitLoss)>0).length/y.value.length*100);function R(){c.value={timestamp:new Date().toISOString().slice(0,16),type:"空單 Sell Limit",price:0,quantity:0,profitLoss:0,notes:""},r.value=!0}function k(){r.value=!1}function X(){if(!c.value.price||!c.value.quantity){alert("請填寫價格和手數");return}const L={timestamp:c.value.timestamp,type:c.value.type,price:c.value.price,quantity:c.value.quantity,profitLoss:c.value.profitLoss.toString(),notes:c.value.notes};t.value.push(L),rt(),k(),e.value=t.value.length-1}function G(){o.value=!o.value,u.value=[]}function Q(){o.value=!1,u.value=[]}function W(L){u.value.includes(L)?u.value=u.value.filter(x=>x!==L):u.value.push(L)}function nt(){u.value.length!==0&&confirm(`確定要刪除選中的 ${u.value.length} 筆紀錄嗎？`)&&(u.value.sort((x,H)=>H-x).forEach(x=>{t.value.splice(x,1)}),rt(),o.value=!1,u.value=[],e.value=null)}function ut(){if(e.value===null)return;const L=t.value[e.value];d.value={timestamp:L.timestamp,type:L.type,price:L.price,quantity:L.quantity,profitLoss:parseFloat(L.profitLoss),notes:L.notes},i.value=!0}function w(){i.value=!1}function v(){if(e.value!==null){if(!d.value.price||!d.value.quantity){alert("請填寫價格和手數");return}t.value[e.value]={timestamp:d.value.timestamp,type:d.value.type,price:d.value.price,quantity:d.value.quantity,profitLoss:d.value.profitLoss.toString(),notes:d.value.notes},rt(),w()}}function _(L){try{return new Date(L).toLocaleString("zh-TW",{year:"numeric",month:"2-digit",day:"2-digit",hour:"2-digit",minute:"2-digit"})}catch{return L}}function b(){l.value=!l.value}function I(){l.value=!1}function P(){if(y.value.length===0)return;const L=E(y.value),x=new Blob([L],{type:"text/html;charset=utf-8"}),H=document.createElement("a"),Ot=URL.createObjectURL(x);H.setAttribute("href",Ot),H.setAttribute("download",`XAUUSD_交易紀錄_${new Date().toISOString().split("T")[0]}.html`),H.style.visibility="hidden",document.body.appendChild(H),H.click(),document.body.removeChild(H),l.value=!1}function E(L){const x=`
    * {
      margin: 0;
      padding: 0;
      box-sizing: border-box;
